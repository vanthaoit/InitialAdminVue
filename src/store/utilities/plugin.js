...
const defaultOptions = {
  confirm: {
    ...
    cancelBtnClass: 'vudal-btn vudal-btn-danger',
  },
};
...
export default {
  install: (Vue, options = {}) => {
    ...
    class Modal {
      ...
      static addDimmer() {
        const dimmer = '<div class="vudal-dimmer create-modal"></div>';
        ...
        new Vue({
          ...
          render(h) {
            return h(Vudal, { class: style, props: { name: 'confirmModal', parent }, on: { hide: this.closeVudal } }, [
              h('div', { class: 'header main center', domProps: { innerHTML: headerMessage } }, []),
              h('div', { class: 'content-message', domProps: { innerHTML: contentMessage } }, []),
              h('div', { class: 'actions' }, [
